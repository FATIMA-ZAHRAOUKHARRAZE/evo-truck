...
@endsection
@section('seo')
    <title>EVO TRUCK - Solutions et Processus de Fabrication</title>
    <meta name="description"
        content="Découvrez le processus de fabrication EVO TRUCK : design, R&D, fabrication, prototypage, tests et confort. Spécialiste en équipements blindés et véhicules de protection depuis plus de 25 ans.">
    <meta name="keywords"
        content="EVO TRUCK solutions, processus de fabrication, design industriel, recherche et développement, prototypage, tests industriels, équipements blindés, véhicules blindés, systèmes balistiques, blindage, véhicules de protection, MRAP, forces spéciales, ingénierie de production, innovation industrielle,maroc">
    <meta name="robots" content="index, follow">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <meta name="author" content="EVO TRUCK">
    <link rel="canonical" href="https://evo-TRUCK.com/solution">
    <meta property="og:title" content="EVO TRUCK - Solutions et Processus de Fabrication">
            ...
            <div class="contain">
                <div class="content-section ">
                    ...
                    <div class="contentS two-column" data-aos="fade-up">
                        <p>
                            {{ translate('Depuis plus de 25 ans, Evo TRUCK est un pionnier de l’industrie en matière de fabrication de véhicules blindés, de systèmes de verre et de châssis balistiques ainsi que diverses fournitures de blindage.
