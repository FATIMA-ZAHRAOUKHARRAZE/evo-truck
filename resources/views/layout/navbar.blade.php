...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <nav id="nav" class="w-nav">
            ...
            <ul class="nav-list" id="menuList">
                ...
                <li class="web-products">
                    <a class="text-white nav-link dropdown-toggle pro" href="#" role="button">
        ...
        <footer class="mb-0 text-center text-white text-lg-start" style="background: #0033cc">
    ...
    <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-17143810638"></script>
<script>
  ...
  gtag('config', 'AW-17143810638');
    ...
    <!-- Google tag (gtag.js) -->
        <script async src="https://www.googletagmanager.com/gtag/js?id=AW-17143810638">
        </script>
        <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
